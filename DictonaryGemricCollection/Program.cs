...
namespace DictonaryGemricCollection
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine(myemployees.Count(emp => emp.Value.name.StartsWith("A")));
            ...
            string value;
            if (mydict.TryGetValue("smle", out value))
            {
            ...
            mydict.TryGetValue("smile", out value);
            Console.WriteLine(value);

            if (mydict.ContainsValue("another man who is unkown.."))
            {
            ...
            Console.WriteLine(mydict.ContainsValue("another man who is unkown.."));

            if (mydict.ContainsKey("smie"))
            {
            ...
            Console.WriteLine(mydict.ContainsKey("smile"));
